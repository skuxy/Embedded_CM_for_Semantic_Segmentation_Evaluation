...
SAVE_DIR=os.path.join('/home/stjepan/FAKS/zavrad/samo_test/',train_helper.get_time_string())
...
flags.DEFINE_string('dataset_dir', '/home/stjepan/FAKS/zavrad/512x256/',
...
flags.DEFINE_string('vgg_init_dir','/home/stjepan/FAKS/zavrad/VGG_TX1','folder with vgg weights')
...
tf.app.flags.DEFINE_string('resume_path','/home/stjepan/FAKS/zavrad/VGG_TX1/model.ckpt','')
